...
<head>
  ...
  <title>SISKO SD Al Azhar 29 BSB City Semarang</title>
  <!-- favicon  -->
  ...
  <div class="container">
    ...
    <div class="col-md-12">
      <div class="header">
        ...
        <div class="info">
          <h1>SISKO SD Al Azhar 29 BSB City Semarang</h1>
      ...
      <nav class="navbar navbar-inverse">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="#">SISKO SD</a></li>
    ...
    <div class="col-md-8">
      ...
      <div class="col-md-12">
        <footer>
          ...
          <p class="link">
            <a href="http://sd-alazhar29.sch.id/" target="_blank">SISKO SD Al Azhar 29 BSB City Semarang</a>
          </p>
          <p>Copyright © 2017</p>
        </footer>      
      </div>
