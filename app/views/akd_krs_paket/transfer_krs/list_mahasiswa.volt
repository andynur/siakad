    ...
    <div class="col-md-10">
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">{{thn_kur}} {{kode_mk}} {{nama}} <span class="text-blue"> Kelas : {{nama_kelas}} </span> | <span class="text-green">Sem : {{semester}}</span> | SKS : {{sks}} </h3>
        </div><!-- /.box-header -->
...
function simpan() {
	...
	var link = '{{ url("akdkrspaket/simpanKrs/") }}';
	var datas = "sesi="+sesi+"&kode_mk="+kode_mk+"&sks="+sks+"&nama_kelas="+nama_kelas+"&thn_kur="+thn_kur+"&jml_mhs="+jml_mhs+"&"+$("form").serialize();
