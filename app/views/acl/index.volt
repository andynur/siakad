<section class="content-header">
  <h1>
    Access Control List
    <small>Manajemen akses menu</small>
  </h1>
  <ol class="breadcrumb">
    <li><a href="#"><i class="fa fa-dashboard"></i> Admin Developer</a></li>
...
<section class="content">
  <div class="row">
    <div class="col-md-12">
      <button class="btn bg-navy btn-flat margin" data-toggle="modal" data-target="#modal_induk"><i class="fa fa-bookmark"></i>&nbsp; Tambah Modul Induk</button>
      <button class="btn bg-navy btn-flat margin" data-toggle="modal" data-target="#modal_anak"><i class="fa fa-list"></i>&nbsp; Tambah Modul Anak</button>
    </div>
    <!-- Modal Induk -->
            ...
            <form class="form-horizontal">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <select id="areas" class="form-control select2" multiple="multiple" data-placeholder="Select a State" style="width: 100%;">
                  <?php foreach ($area as $key => $value): ?>
                    <option value="<?= $value['id'] ?>"><?= $value['label_menu'] ?></option>            
                  <?php endforeach ?>
                </select>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label class="col-sm-3 control-label">Urut</label>
                  <div class="col-sm-9">
                    <input type="taxt" class="form-control" id="uruts" placeholder="urut">
                  </div>
                </div>
              </div>
              <!-- /.box-body -->
            ...
            <form class="form-horizontal">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label class="col-sm-3 control-label">Area</label>
                  <div class="col-sm-9">
                    <select id="area" class="form-control select2" multiple="multiple" data-placeholder="Select a State" style="width: 100%;">
                  <?php foreach ($area as $key => $value): ?>
                    <option value="<?= $value['id'] ?>"><?= $value['label_menu'] ?></option>            
                  <?php endforeach ?>
                </select>
                    <p class="text-aqua">kalo mau dijadikan menu paling depan <b>area</b> di isi</p>
                    <p class="text-aqua">kalo mau dijadikan anak menu di kosongi saja</p>
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label class="col-sm-3 control-label">Urut</label>
                  <div class="col-sm-9">
                    <input type="taxt" class="form-control" id="urut" placeholder="urut">
                  </div>
                </div>
              </div>
              <!-- /.box-body -->
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <table class="table table-bordered" style="border-collapse:collapse;">
            ...
            <tbody>
              <?php 
              function loop($acl, $usergroup, $area)
              {
                foreach ($acl as $key => $value) {
                  if (!empty($value['child'])) {
                    if ($value['controller'] == '') {
                      $jenis = '<span class="badge bg-light-blue">Parent</span>';
                    } else {
                      $jenis = $value['controller'].'/'.$value['action'];
                    }
              ?>

              <tr data-toggle="collapse" data-target="#demo<?=$value['id']?>" class="accordion-toggle">
                ...
                <td class="text-light-blue"><i class="fa <?= $value['icon'] ?>"></i>
                  <?=$value['label_menu']?> &nbsp; <i class="fa fa-arrow-circle-down"></i>
                </td>
                <td style="">
                  <?=$jenis?>
                </td>
                          ...
                          <form class="form-horizontal">
                            <div class="box-body">
                              ...
                              <div class="form-group">
                                <label class="col-sm-3 control-label">Area</label>
                                <div class="col-sm-9">
                                  <select id="areas<?=$value['id']?>" class="form-control select2" multiple="multiple" data-placeholder="Select a State" style="width: 100%;">
                                  <?php $r = array_filter(explode(',', $value['area']));?>
                                    <?php foreach ($area as $uskey => $us): ?>
                                      <?php if (in_array($us['id'], $r)): ?>
                                        <option value="<?= $us['id'] ?>" selected><?= $us['label_menu'] ?></option>            
                                      <?php else: ?>
                                        <option value="<?= $us['id'] ?>"><?= $us['label_menu'] ?></option>            
                                      <?php endif ?>
                                    <?php endforeach ?>  
                                  </select>
                                </div>
                              ...
                              <div class="form-group">
                                <label class="col-sm-3 control-label">Usergroup</label>
                                <div class="col-sm-9">
                                  <select id="usergroups<?=$value['id']?>" class="form-control select2" multiple="multiple" data-placeholder="Select a State"
                                    style="width: 100%;">
                              ...
                              <div class="form-group">
                                <label class="col-sm-3 control-label">Urut</label>
                                <div class="col-sm-9">
                                  <input type="taxt" class="form-control" id="uruts<?=$value['id']?>" value="<?= $value['urut'] ?>">
                                </div>
                              </div>
                            </div>
                            <!-- /.box-body -->
              ...
              <tr>
                ...
                <td colspan="7" class="hiddenRow">
                  <div style="width: 100%; " id="demo<?=$value['id']?>" class="accordian-body collapse">
                    <table class="table table-bordered" style="border-collapse:collapse;">
                      <thead>
                        <tr>
                          <th style="width: 25px;">ID</th>
                      ...
                      <tbody>
                        <?php loop($value['child'], $usergroup, $area);  ?>
                      </tbody>
                    </table>
                  </div>
                </td>
              ...
              <?php } else {
                    if ($value['controller'] == '') {$jenis = '<span class="badge bg-light-blue">Parent</span>';}else{$jenis = $value['controller'].'/'.$value['action'];}
              ...
              <tr>
                ...
                <td style=""><i class="fa <?= $value['icon'] ?>"></i>
                  <?=$value['label_menu']?>
                </td>
                <td style="">
                  <?=$jenis?>
                          ...
                          <form class="form-horizontal">
                            <div class="box-body">
                              ...
                              <div class="form-group">
                                <label class="col-sm-3 control-label">Area</label>
                                <div class="col-sm-9">
                                  <select id="area<?=$value['id']?>" class="form-control select2" multiple="multiple" data-placeholder="Select a State" style="width: 100%;">
                              ...
                              <div class="form-group">
                                <label class="col-sm-3 control-label">Usergroup</label>
                                <div class="col-sm-9">
                                  <select id="usergroup<?=$value['id']?>" class="form-control select2" multiple="multiple" data-placeholder="Select a State"
                                    style="width: 100%;">
                                    <?php $r = array_filter(explode(',', $value['usergroup_id']));?>
                                    <?php foreach ($usergroup as $uskey => $us): ?>
                                    <?php if (in_array($us['id'], $r)): ?>
                              ...
                              <div class="form-group">
                                <label class="col-sm-3 control-label">Urut</label>
                                <div class="col-sm-9">
                                  <input type="taxt" class="form-control" id="urut<?=$value['id']?>" value="<?= $value['urut'] ?>">
                                </div>
                              </div>
                            </div>
                            <!-- /.box-body -->
...
<script>
  ...
  function induk_edit(id) {
    ...
    var urut1 = $("#uruts" + id).val();

    var datas = "label_menu1=" + label_menu1 + "&area1=" + area1 + "&parent1=" + parent1 + "&usergroup1=" + usergroup1 +
      "&kecuali_user1=" + kecuali_user1 + "&aktif1=" + aktif1 + "&icon1=" + icon1 + "&urut1=" + urut1;
    var urel = '{{ url("acl/editIndukMenu/") }}' + id;

    if (usergroup1 == '' || usergroup1 == null || area1 == '' || area1 == null) {
      new PNotify({
        title: 'Regular Notice',
        text: 'Usergroup dan area tidakboleh kosong.',
        type: 'warning'
      });
    } else {
      $.ajax({
  ...
  function anak_edit(id) {
    ...
    var urut = $("#urut" + id).val();

    var datas = "label_menu=" + label_menu + "&controller=" + controller + "&action=" + action + "&parent=" + parent +
      "&usergroup=" + usergroup + "&kecuali_user=" + kecuali_user + "&aktif=" + aktif + "&icon=" + icon + "&area=" +
      area + "&urut=" + urut;
