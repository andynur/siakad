...
<script>
  ...
  function induk_edit(id) {
    ...
    var datas = "label_menu1="+label_menu1+"&area1="+area1+"&parent1="+parent1+"&usergroup1="+usergroup1+"&kecuali_user1="+kecuali_user1+"&aktif1="+aktif1+"&icon1="+icon1+"&urut1="+urut1;
  ...
  function anak_edit(id) {
    ...
    var datas = "label_menu="+label_menu+"&controller="+controller+"&action="+action+"&parent="+parent+"&usergroup="+usergroup+"&kecuali_user="+kecuali_user+"&aktif="+aktif+"&icon="+icon+"&area="+area+"&urut="+urut;
