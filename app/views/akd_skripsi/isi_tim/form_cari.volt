    ...
    <div class="col-md-6">
	    <div class="box">
	        ...
	        <form method="post">
	            ...
	            <button style="margin: 0;" type="button" onclick="dataPeriodeSkripsi()" class="btn bg-navy btn-flat pull-right"><i class="fa fa-fw fa-search"></i> Cari</button>
	        </form>
	        </div>
	    </div>
	 </div>
...
function dataPeriodeSkripsi() {
	var link = '{{ url("akdisitim/dataPeriodeSkripsi/") }}';
