    ...
    <div class="col-md-12 form_data">
      ...
      <nav class="navbar navbar-default" role="navigation" style="    height: 50px;">
        ...
        <ul class="nav navbar-nav" style="align-text: center;">
          <li><a href="#javascript:void(0)" onclick="return go_page('akdmhs/data/'+{{ data.id_mhs }})" data-toggle="tab">BIODATA</a></li>
          <li class="active"><a href="javascript:void(0)" onclick="return go_page('akdmhs/krs_khs/'+{{ data.id_mhs }})" data-toggle="tab">KRS/KHS</a></li>
          ...
          <li><a href="javascript:void(0)" onclick="return go_page('akdmhs/data/'+{{ data.id_mhs }})" data-toggle="tab">EVALUASI DIRI</a></li>
        </ul>
      </div><!-- /.navbar-collapse -->
    </nav>
