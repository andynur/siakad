...
<button type="button" onclick="uncek_all()" style="display: none;" class="uncheckAll btn btn-info btn-flat margin btn-xs"><i class="fa fa-fw fa-check-square-o"></i> Semua</button>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if ($v['keu'] == 'kosong'): ?>
                                <p class="text-yellow">Belum melakukan pembayaran {{nama_byr}}</p>
                                <?php endif ?>
                                <?php if ($v['krs'] == 'kosong'): ?>
                                <p class="text-red">Belum melakukan KRS'an</p>
                                <?php endif ?>
                            <td>
                                <input name="mhs[<?= $v['id_mhs'] ?>]" type="checkbox" style="float: left; margin-top: 10px;">
                                <?php if ($v['keu'] == 'kosong'): ?>
                                <input name="ket_keu[<?= $v['id_mhs'] ?>]" type="text" style="display: none;" value="keu"  >
                                <?php endif ?>
                                <?php if ($v['krs'] == 'kosong'): ?>
                                <input name="ket_krs[<?= $v['id_mhs'] ?>]" type="text" style="display: none;" value="krs"  >
                                <?php endif ?>
                            </td>
...
function update_mhs(){
    ...
    if (mhs.length == 0) {
        ...
        var link = '{{ url("akdmhsna/submitMhsNa/") }}';
