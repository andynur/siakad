...
<nav class="navbar navbar-default" role="navigation" style="    height: 50px;">
  ...
  <ul class="nav navbar-nav" style="align-text: center;">
    ...
    <li class="active"><a href="javascript:void(0)" onclick="return go_page('akdmhsna/find/')" data-toggle="tab">NON AKTIF</a></li>
  </ul>
  </div><!-- /.navbar-collapse -->
</nav>
    ...
    <!-- row -->
    <div class="row">
<p class="lead text-navy" style="text-align: center;"><b>Mahasiswa Non Aktif</b></p>
...
<script type="text/javascript">
    function cari() {
        ...
        if(angkatan) {
            var link = '{{ url("akdmhsna/mahasiswa/") }}';
