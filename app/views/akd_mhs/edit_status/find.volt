...
<nav class="navbar navbar-default" role="navigation" style="    height: 50px;">
  ...
  <ul class="nav navbar-nav" style="align-text: center;">
    ...
    <li class="active"><a href="javascript:void(0)" onclick="return go_page('akdstatusmhs/editStatus/')" data-toggle="tab">EDIT STATUS</a></li>
    ...
    <!-- row -->
    <div class="row">
<p class="lead" style="text-align: center;">Ubah Status Mahasiswa</p>
...
<script type="text/javascript">
    function cari() {
        ...
        if(range1 && range2 || nama_mhs || angkatan) {
            var link = '{{ url("akdstatusmhs/mahasiswaEditStatus/") }}';
