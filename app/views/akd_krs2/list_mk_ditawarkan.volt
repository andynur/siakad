...
function pilih(kode_mk) {
  ...
  var urel = '{{ url("akdkrs/addKrs/") }}';
  var datas = "ps_id="+ps_id+"&psmhs_id="+psmhs_id+"&thn_akd="+thn_akd+"&kode_mk="+kode_mk+"&session_id="+session_id+"&thn_kur="+thn_kur+"&nomhs="+nomhs+"&kelas="+kelas+"&jam_awal="+jam_awal+"&jam_akhir="+jam_akhir+"&hari="+hari+"&sks="+sks;
  $.ajax({
     type: "POST",
     url: urel,
     dataType : "json",
