...
class AclController extends \Phalcon\Mvc\Controller
{
    ...
    public function indexAction()
    {
        if (empty($this->session->get('uid'))) {
            ...
            $phql = "SELECT * from RefArea where aktif = 'Y' ";
            $area = $this->modelsManager->executeQuery($phql)->toArray();
    ...
    function addIndukMenuAction()
    {
        ...
        $validation->add('area1', new PresenceOf(array(
            'message' => 'area Group tidak boleh kosong'
        )));
