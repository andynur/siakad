...
define('BASE_URL', 'http://localhost/sia/');
define('PUBLIC_URL', 'http://localhost/sia/public/');
define('DOCUMENT_ROOT', $_SERVER['DOCUMENT_ROOT'].'/sia/public/');
